...
extern "C" const uint8_T invADCsequencer[invADCchannels] = {ADC_INPUTCTRL_MUXPOS_PIN17, ADC_INPUTCTRL_MUXPOS_PIN18, ADC_INPUTCTRL_MUXPOS_PIN0, ADC_INPUTCTRL_MUXPOS_PIN1};
