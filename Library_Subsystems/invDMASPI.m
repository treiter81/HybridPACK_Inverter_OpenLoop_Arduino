classdef invDMASPI < matlab.System & coder.ExternalDependency
    ...
    methods
        % Constructor
        function obj = invDMASPI(varargin)
...
%        function setupImpl(obj, fsw, dT) 
        ...
        function [DCL_RAW] = stepImpl(obj)  
            ...
            if isempty(coder.target)
                ...
                DCL_RAW = coder.ceval('DMAreadwriteSPI',uint16(0));                
            end
        end
    ...
    methods (Access=protected)
        ...
        function icon = getIconImpl(~)
            ...
            icon = 'Inverter DMA SPI Arduino Nano 33 IoT';
        end
    end
    ...
    methods (Static)
        function name = getDescriptiveName()
            name = 'Inverter DMA SPI external ADC Read';
        end
        ...
        function updateBuildInfo(buildInfo, context)
            if context.isCodeGenTarget('rtw')
                ...
                addSourceFiles(buildInfo,'invDMASPI.cpp',srcDir);
